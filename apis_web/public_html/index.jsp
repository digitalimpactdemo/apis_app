                    ...
                    <div id="content">
                        <blockquote>
                            <p style="text-transform: uppercase;">
                                <span id="apiName">Digital Impact Demo</span>
                            </p>
                            <small>
                        ...
                        <c:set var="apis"
                               value="<%=oracle.digitalimpact.demo.apis.factories.APIFactory.getInstance ().getApis()%>"/>
                                        ...
                                        <table style="table-layout: fixed;"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <code><a href="${pageContext.request.contextPath}/services/rest${api.path}" target="_blank">${pageContext.request.contextPath}/services/rest${api.path}</a></code>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Produces</th>
